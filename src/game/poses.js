...
(function (P) {
  ...
  // eight-frame run cycle. Frames 5-8 are 1-4 with the legs and arms
  // swapped, which also swaps which leg gets the lit shade -- the legs read
  // as alternating in front, for free.
  var RUN = [
    pz(0, 26, -72, -78, 80, -25, 112, 125, 112, 125, -20, 68, 88, 5),
    pz(0, 24, -70, -78, 88, -8, 106, 118, 116, 142, -30, 82, 92, 0),
    pz(0, 25, -70, -80, 98, 25, 98, 100, 100, 140, -44, 96, 96, 8),
    pz(0, 27, -73, -80, 108, 70, 88, 40, 80, 146, -30, 112, 118, -10),
    pz(0, 26, -72, -78, 112, 125, 80, -25, 68, 88, 5, 112, 125, -20),
    pz(0, 24, -70, -78, 106, 118, 88, -8, 82, 92, 0, 116, 142, -30),
    pz(0, 25, -70, -80, 98, 100, 98, 25, 96, 96, 8, 100, 140, -44),
    pz(0, 27, -73, -80, 88, 40, 108, 70, 112, 118, -10, 80, 146, -30)
  ];
  ...
  var CLIPS = {
    ...
    hang: {
      n: 12,
      keys: [
        [0, pz(0, 33, -88, -84, -86, -89, -88, -89, 84, 96, 20, 90, 100, 16)],
        [3, pz(0, 32, -86, -82, -86, -89, -88, -89, 74, 88, 26, 80, 92, 22)],
        [6, pz(0, 33, -88, -84, -86, -89, -88, -89, 88, 98, 18, 94, 102, 14)],
        [9, pz(0, 32, -90, -86, -86, -89, -88, -89, 100, 110, 8, 106, 114, 6)],
        [11, pz(0, 33, -88, -84, -86, -89, -88, -89, 86, 97, 19, 92, 101, 15)]
      ]
    },
    hangstraight: {
      frames: [pz(0, 33, -89, -86, -87, -89, -88, -89, 90, 96, 14, 95, 99, 12)]
    },
    ...
    hangdrop: {
      n: 6,
      keys: [
        [0, pz(0, 33, -88, -84, -74, -84, -78, -85, 92, 104, 10, 98, 108, 8)],
        [1, pz(0, 29, -86, -84, -30, -50, -36, -54, 96, 118, 4, 102, 122, 4)],
        [2, pz(0, 22, -74, -80, 30, 20, 24, 14, 98, 132, 0, 104, 136, 2)],
        [3, CROUCH],
        [5, STAND]
      ]
    },
    ...
    climbup: {
      n: 15,
      keys: [
        [0, pz(0, 33, -88, -84, -86, -89, -88, -89, 88, 98, 18, 94, 102, 14)],
        [2, pz(0, 37, -86, -80, -82, -112, -84, -110, 84, 104, 16, 90, 108, 12)],
        [4, pz(0, 42, -84, -76, -78, -130, -80, -128, 80, 112, 12, 86, 116, 10)],
        [5, pz(0, 46, -82, -74, -76, -142, -78, -140, 76, 120, 8, 82, 124, 6)],
